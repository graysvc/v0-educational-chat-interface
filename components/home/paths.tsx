  ...
  return (
    <section className="px-6 py-12 md:py-16">
      <div className="mx-auto max-w-4xl">
        <h2 className="text-center text-base font-semibold tracking-widest uppercase text-muted-foreground md:text-lg">
          ...
          {paths.map((path) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className="mt-7 inline-flex h-12 items-center rounded-lg border-2 border-border bg-background px-6 text-base font-semibold text-foreground transition-all group-hover:border-muted-foreground/30 group-hover:bg-accent"
                >
                  {path.label}
                </span>
              </Link>
