...
export function VideoCard({ title, description, duration, thumbnail, onClick }: VideoCardProps) {
  return (
    <button
      type="button"
      onClick={onClick}
    ...
    >
      <div className="relative aspect-video w-full overflow-hidden bg-muted">
        ...
        <span className="absolute right-3 bottom-3 rounded-md bg-foreground/70 px-2 py-0.5 text-xs font-medium text-primary-foreground">
          {duration}
        </span>
      </div>
      <div className="p-5">
