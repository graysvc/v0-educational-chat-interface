    ...
    >
      <div className="relative w-full max-w-2xl overflow-hidden rounded-2xl bg-card shadow-lg">
        <button
          type="button"
          onClick={onClose}
          className="absolute top-4 right-4 z-10 flex h-10 w-10 items-center justify-center rounded-full bg-foreground/70 text-primary-foreground transition-opacity hover:opacity-80 focus:outline-none focus-visible:ring-2 focus-visible:ring-ring"
