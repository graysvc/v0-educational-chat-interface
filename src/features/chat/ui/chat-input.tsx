      ...
      <div className="border-t border-border bg-background px-4 pb-6 pt-4 md:px-6">
        ...
        >
          ...
          <button
            ...
            className="flex h-[56px] shrink-0 items-center gap-2 rounded-xl bg-primary px-7 text-base font-semibold uppercase tracking-wide text-primary-foreground transition-opacity hover:opacity-90 focus:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:opacity-30"
          >
            Enviar
